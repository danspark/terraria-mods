...
internal static class WorldPlanner
{
	...
	private static void RejectUnsupportedWorldVariants()
	{
		...
		throw new NotSupportedException(
			"Vanilla Worlds Overhauled currently supports ordinary Terraria seeds only. "
			+ "Secret seeds alter biome layers and progression-site assumptions, so generation stops before Vanilla Worlds Overhauled mutates the world.");
	}
