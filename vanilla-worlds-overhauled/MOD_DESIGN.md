...
Manifest version 7 saves terraces; landmark archetype, room, floor, stair, layout, and furniture records; mountain grammar, decoration, and water measurements; Forest lake crossings and their replay seeds; valleys; bridge graveyard selections and retained tombstone counts; highland style and attachment state; surviving biome transitions; mine sections; the mine graph summary; accents; and the final validation summary. Loading restores this manifest even though no generation plan exists at runtime. Saving a loaded world preserves the restored data.
