...
package="$build_save_dir/Mods/VanillaWorldsOverhauled.tmod"
local_save_dir="${TML_SAVE_DIRECTORY:-$HOME/.local/share/Terraria/tModLoader}"
installed_package="$local_save_dir/Mods/VanillaWorldsOverhauled.tmod"
legacy_package="$build_save_dir/Mods/RicherBiomes.tmod"
legacy_installed_package="$local_save_dir/Mods/RicherBiomes.tmod"
...
ln -s "$mod_dir" "$stage_dir/VanillaWorldsOverhauled"
mkdir -p "$build_save_dir/Mods"

dotnet build "$stage_dir/VanillaWorldsOverhauled/VanillaWorldsOverhauled.csproj" \
...
rm -f -- "$legacy_package" "$legacy_installed_package"
