# Vanilla Worlds Overhauled world generation ideas

Vanilla Worlds Overhauled reshapes Terraria's existing biomes without replacing their materials, progression, or identity. The world remains readable as Terraria, but its terrain gives the player more reasons to climb, descend, explore, and choose a route.
...
- Build for a coherent Vanilla Worlds Overhauled world. Compatibility with other mods that replace world generation is not a design constraint.
...
Granite, Marble, Spider Caves, Bee Hives, and the Aether keep their vanilla identity and required contents. When Vanilla Worlds Overhauled changes one of them, the result becomes a multi-room region with several routes. The generator leaves an unchanged vanilla site when it cannot allocate enough space for a large version.
