...
if ! grep -Eq 'Loaded Richer Biomes manifest v6: landmarks=11; mountains=[1-9][0-9]*; bridges=[1-9][0-9]*; forestLakeBridges=[0-9]+; mountainWaters=[1-9][0-9]*; skyHighlands=[1-9][0-9]*; mine=present; validation=valid=True' "$reload_log"; then
...
if ! grep -Eq 'Loaded Richer Biomes manifest v6: landmarks=11; mountains=[1-9][0-9]*; bridges=[1-9][0-9]*; forestLakeBridges=[0-9]+; mountainWaters=[1-9][0-9]*; skyHighlands=[1-9][0-9]*; mine=present; validation=valid=True' "$persistence_log"; then
