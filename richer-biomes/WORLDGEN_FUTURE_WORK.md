...
| Trees, plants, vines, cactus, coral, and ambient biome decoration | Partial | Terraria owns region-wide vegetation. Richer Biomes adds contextual debris and dense mountain vine curtains, including humidity-biased growth around its water bodies, plus pots, rubble, torches, and climb aids. | Add planting passes for each biome-specific terrain family after their route and structure bounds become stable. |
